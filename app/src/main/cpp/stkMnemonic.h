...
enum ZX_CODE_BUTTON {
    CB_NA = 0, CB_0, CB_1, CB_2, CB_3, CB_4, CB_5, CB_6, CB_7, CB_8, CB_9,
    ...
    CB_NEW, CB_SAVE, CB_DIM, CB_FOR, CB_GOTO, CB_GOSUB, CB_LOAD, CB_LIST, CB_LET, CB_COPY, CB_CLEAR,
    ...
    CB_LINE, CB_ERASE, CB_MOVE, CB_CAT, CB_CC, CB_GG, CB_TR, CB_INV, CB_SQR, CB_PI, CB_LL, CB_EE, CB_TILDA, CB_IN, CB_ILI,
    CB_TILE, CB_BREAK
};
...
static uint8_t buttons[] = {
        ...
        CB_CLS, 0, CB_BORDER, 0, CB_NEXT, 0, CB_PAUSE, 0,
        ...
        CB_LLIST, 0, CB_BIN, 0, CB_INKEYS_, 0, CB_PI, 0,
        ...
        CB_SPACE, 0, CB_FLUSH, 0, CB_BRIGHT, 0, CB_OVER, 0, CB_INVERSE, 0,
        ...
        CB_NOT, 0, CB_STEP, 0, CB_TO, 0, CB_THEN, 0, CB_EXCLAMATION, 0, CB_MINUS, 0, CB_PLUS, 0, CB_EQ, 0, CB_TILE, 13, CB_EE, 0, CB_COLON, 0, CB_TILE, 0, CB_QUEST, 0,
        CB_SPACE, 0, CB_DIV, 0, CB_MUL, 0, CB_COMMA, 0, CB_PT, 0,
        ...
        CB_TILE, 5, CB_SIN, 0, CB_COS, 0, CB_TAN, 0, CB_INT, 0, CB_RND, 0, CB_STR_, 0, CB_CHR_, 0, CB_CODE, 0, CB_PEEK, 0, CB_TAB, 0, CB_TILE, 6, CB_TILE, 11, CB_READ, 0,
        CB_RESTORE, 0, CB_DATA, 0, CB_SGN, 0, CB_ABS, 0, CB_SQR, 0, CB_VAL, 0, CB_LEN, 0, CB_USR, 0, CB_TILE, 12, CB_LL, 0, CB_LN, 0, CB_EXP, 0, CB_LPRINT, 0, CB_BREAK, 0,
        CB_LLIST, 0, CB_BIN, 0, CB_INKEYS_, 0, CB_PI, 0,
};
...
static MNEMONIC mnemonics[] = {
        ...
        BIT_X(_RB), BIT_X(_RC), BIT_X(_RD), BIT_X(_RE), BIT_X(_RH), BIT_X(_RL), { _RPHL, _BT, O_BIT, _T(1, 12), C_BIT, F_BIT }, BIT_X(_RA),
        BIT_X(_RB), BIT_X(_RC), BIT_X(_RD), BIT_X(_RE), BIT_X(_RH), BIT_X(_RL), { _RPHL, _BT, O_BIT, _T(1, 12), C_BIT, F_BIT }, BIT_X(_RA),
        BIT_X(_RB), BIT_X(_RC), BIT_X(_RD), BIT_X(_RE), BIT_X(_RH), BIT_X(_RL), { _RPHL, _BT, O_BIT, _T(1, 12), C_BIT, F_BIT }, BIT_X(_RA),
        BIT_X(_RB), BIT_X(_RC), BIT_X(_RD), BIT_X(_RE), BIT_X(_RH), BIT_X(_RL), { _RPHL, _BT, O_BIT, _T(1, 12), C_BIT, F_BIT }, BIT_X(_RA),
        BIT_X(_RB), BIT_X(_RC), BIT_X(_RD), BIT_X(_RE), BIT_X(_RH), BIT_X(_RL), { _RPHL, _BT, O_BIT, _T(1, 12), C_BIT, F_BIT }, BIT_X(_RA),
        ...
        RES_X(_RB), RES_X(_RC), RES_X(_RD), RES_X(_RE), RES_X(_RH), RES_X(_RL), { _RPHL, _BT, O_RES, _T(1, 15), C_RES }, RES_X(_RA),
        RES_X(_RB), RES_X(_RC), RES_X(_RD), RES_X(_RE), RES_X(_RH), RES_X(_RL), { _RPHL, _BT, O_RES, _T(1, 15), C_RES }, RES_X(_RA),
        RES_X(_RB), RES_X(_RC), RES_X(_RD), RES_X(_RE), RES_X(_RH), RES_X(_RL), { _RPHL, _BT, O_RES, _T(1, 15), C_RES }, RES_X(_RA),
        RES_X(_RB), RES_X(_RC), RES_X(_RD), RES_X(_RE), RES_X(_RH), RES_X(_RL), { _RPHL, _BT, O_RES, _T(1, 15), C_RES }, RES_X(_RA),
        RES_X(_RB), RES_X(_RC), RES_X(_RD), RES_X(_RE), RES_X(_RH), RES_X(_RL), { _RPHL, _BT, O_RES, _T(1, 15), C_RES }, RES_X(_RA),
        ...
        SET_X(_RB), SET_X(_RC), SET_X(_RD), SET_X(_RE), SET_X(_RH), SET_X(_RL), { _RPHL, _BT, O_SET, _T(1, 15), C_SET }, SET_X(_RA),
        SET_X(_RB), SET_X(_RC), SET_X(_RD), SET_X(_RE), SET_X(_RH), SET_X(_RL), { _RPHL, _BT, O_SET, _T(1, 15), C_SET }, SET_X(_RA),
        SET_X(_RB), SET_X(_RC), SET_X(_RD), SET_X(_RE), SET_X(_RH), SET_X(_RL), { _RPHL, _BT, O_SET, _T(1, 15), C_SET }, SET_X(_RA),
        SET_X(_RB), SET_X(_RC), SET_X(_RD), SET_X(_RE), SET_X(_RH), SET_X(_RL), { _RPHL, _BT, O_SET, _T(1, 15), C_SET }, SET_X(_RA),
        SET_X(_RB), SET_X(_RC), SET_X(_RD), SET_X(_RE), SET_X(_RH), SET_X(_RL), { _RPHL, _BT, O_SET, _T(1, 15), C_SET }, SET_X(_RA),
