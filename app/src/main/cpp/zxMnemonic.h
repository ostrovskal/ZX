...
enum MnemonicED {
    ...
    LD_HL1_PNN, NEG_5, RETI_2, IM0_3, RLD, IN_F_PC, OUT_PC_0, SBC_HL_SP, LD_PNN_SP, NEG_6, RETN_3, IM1_1, NOP_1, IN_A_BC, OUT_PC_A,
    ADC_HL_SP, LD_SP_PNN, NEG_7, RETI_3, IM2_1, NOP_2, LDI = 160, CPI, INI, OUTI, LDD = 168, CPD, IND, OUTD,
